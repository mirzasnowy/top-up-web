...
import { Snowflake, Mail, MessageCircle, Send, Instagram, Facebook } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-600 max-w-sm">
              ...
              Nikmati pengalaman bermain game tanpa batas.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm text-gray-700 font-medium">support@snowystore.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <MessageCircle className="h-4 w-4 text-green-500" />
                <span className="text-sm text-gray-700 font-medium">+62 812-3456-7890</span>
              </div>
              <div className="flex items-center space-x-3">
                <Send className="h-4 w-4 text-blue-500" />
                <span className="text-sm text-gray-700 font-medium">@SnowyStoreCS</span>
              </div>
            </div>
          </div>
